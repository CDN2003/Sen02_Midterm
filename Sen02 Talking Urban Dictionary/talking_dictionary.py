...
source.title('TalkTionary created by Flores, Sibugal, Siron and Talplacido')
...
enterWordEntry = Entry(source, font=('arial', 23, 'bold'), fg='white', bg='sienna4', bd=8, relief=RIDGE, justify=CENTER)
...
textArea = Text(source, font=('arial', 14, 'normal'), fg='white', bg='sienna4', height=10, width=50, bd=8, relief=RIDGE, wrap='word')
